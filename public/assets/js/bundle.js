...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWRhbWdhbGkiLCJhIjoiY2szNmEzd214MGNvdjNsbnNwZDR1MTFuNCJ9.3ca8vjSBjp4hE6vR2pCRCw';
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(firstName, lastName, email, password, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Welcome, great to have you!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_vFG1Q2EX3kxb4ivxPpnzKL4e00xEHDTpLY');
...
var DOMstrings = {
  ...
  inputSignupPasswordConfrm: document.querySelector('.password_confrm_validation'),
  passwordSignupConfrmErrorMsg: document.querySelector('.password_signup_confrm_err_msg')
};
...
function Auth(input, err_msg, regex, txt1, txt2) {
  ...
  this.txt1 = txt1;
  this.txt2 = txt2;
  if (input) document.addEventListener('invalid', function () {
    return function (e) {
      e.preventDefault();
      input.focus();
    };
...
if (DOMstrings.mapBox) {
  var locations = JSON.parse(DOMstrings.mapBox.dataset.locations);
  (0, _mapbox.displayMap)(locations);
}

if (DOMstrings.loginForm) DOMstrings.loginForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  (0, _auth.login)(email, password);
});
if (DOMstrings.signupForm) DOMstrings.signupForm.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (window.location.href === 'http://localhost:3000/login') {
  var loginEmail = new Auth(DOMstrings.inputLoginEmail, DOMstrings.emailLoginErrorMsg, /\S+@\S+\.\S+/, 'Please enter your email here.', 'Please enter a valid email here.');
  var loginPassword = new Auth(DOMstrings.inputLoginPassword, DOMstrings.passwordLoginErrorMsg, /\S+[a-zA-Z]{2,8}\S+\.\S+/, 'Please enter your password here', 'Your password must be at least 8 characters long');
  loginEmail();
  loginPassword();
} else if (window.location.href === 'http://localhost:3000/signup') {
  var signUpFrstName = new Auth(DOMstrings.inputFirstName, DOMstrings.firstnameErrorMsg, /\S+[a-zA-Z]{3,}/, 'Please enter your first name here', 'Please enter a valid first name');
  var signupLastName = new Auth(DOMstrings.inputLastName, DOMstrings.lastNameErrorMsg, /^\w{1,10}$/, 'Please enter your last name here', 'Please enter a valid last name');
  var signupEmail = new Auth(DOMstrings.inputSignupEmail, DOMstrings.emailSignupErrorMsg, /\S+@\S+\.\S+/, 'Please enter your email here', 'Please enter a valid email');
  var signupPassword = new Auth(DOMstrings.inputSignupPassword, DOMstrings.passwordSignupErrorMsg, /^[a-zA-Z]{8,}$/, 'Please enter your password here', 'Passwords must be at least 8 characters');
  var signupPasswordConfrm = new Auth(DOMstrings.inputSignupPasswordConfrm, DOMstrings.passwordSignupConfrmErrorMsg, /^[a-zA-Z]{8,}$/, 'Your passwords don\'t match.', '');
  signUpFrstName();
  signupLastName();
  signupEmail();
  signupPassword();
...
if (DOMstrings.logOutBtn) DOMstrings.logOutBtn.addEventListener('click', _auth.logout);
if (DOMstrings.userDataForm) DOMstrings.userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (DOMstrings.userPasswordForm) DOMstrings.userPasswordForm.addEventListener('submit',
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
...
if (DOMstrings.bookBtn) DOMstrings.bookBtn.addEventListener('click', function (e) {
...
window.onload = function () {
  ...
  (function () {
    if (sessionStorage.getItem('firstVisit') === "1") {
      ...
      DOMstrings.popupClose.addEventListener('click', function (e) {
        e.preventDefault();
